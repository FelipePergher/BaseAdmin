// <copyright file="EnableAuthenticator.cshtml.cs" company="Felipe Pergher">
...
namespace BaseAdminProject.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(BaseAdminUser user)
        {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("BaseAdminProject"),
