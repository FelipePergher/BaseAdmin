// <copyright file="DownloadPersonalData.cshtml.cs" company="Felipe Pergher">
...
namespace BaseAdminProject.Areas.Identity.Pages.Account.Manage
{
    public class DownloadPersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            IEnumerable<System.Reflection.PropertyInfo> personalDataProps = typeof(BaseAdminUser).GetProperties().Where(
